        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                onChange={onChange}
                type="text"
                className="w-full px-4 py-3 rounded-lg bg-white text-black border border-black/20 focus:outline-none focus:ring-2 focus:ring-black dark:bg-black dark:text-white dark:border-white/20 dark:focus:ring-white"
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full md:w-auto px-6 py-3 rounded-lg border border-green-600
    bg-green-600 text-white  hover:bg-green-700 hover:text-white transition-colors disabled:opacity-60 dark:border-white dark:bg-white dark:text-black dark:hover:bg-black dark:hover:text-white"
            >
