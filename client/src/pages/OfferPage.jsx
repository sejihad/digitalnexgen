...
const OfferPage = () => {
      ...
      try {
        ...
        if (response.data.length > 0) {
          ...
          try {
            ...
            try {
              window.dispatchEvent(new CustomEvent('offerEndTimeUpdated', { detail: { offerEndTime: earliestEndDate } }));
            } catch {
          ...
          try {
            ...
            try {
              window.dispatchEvent(new CustomEvent('offerEndTimeUpdated', { detail: { offerEndTime: null } }));
            } catch {
              // ignore
            }
          } catch (err) {
  ...
  if (offers.length === 0) {
    return (
      <>
        <div className="relative w-11/12 max-w-[1440px] mx-auto mt-6 dark:bg-white/10 rounded-2xl shadow-lg backdrop-blur-lg border border-white/20 flex flex-col justify-center items-center overflow-hidden border-gray-200 dark:border-gray-900 bg-tea-Green" style={{ minHeight: "450px" }}>
          ...
          <div
            ...
            style={{
              height: "500px",
              width: "500px",
              background: "radial-gradient(circle, rgba(255, 122, 94, 0.8), rgba(0,0,0,0) 70%)",
              borderRadius: "50%",
            }}
          ></div>
          ...
          <div
            ...
            style={{
              height: "500px",
              width: "500px",
              background: "radial-gradient(circle, rgba(100, 160, 255, 0.8), rgba(0,0,0,0) 70%)",
              borderRadius: "50%",
            }}
          ></div>
        </div>
