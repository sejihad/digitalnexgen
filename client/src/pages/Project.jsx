...
const ProjectPage = () => {
  ...
  const filteredProjects = projects.filter((project) => {
    ...
    if (selectedSubCategory) {
      const subMatch = project.subCategory.toLowerCase() === selectedSubCategory.toLowerCase();
        ...
        <div className="w-11/12 mx-auto max-w-[1440px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-lg font-bold text-primaryText dark:text-white mb-2">{project.title}</h3>
