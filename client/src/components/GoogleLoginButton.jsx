...
const GoogleLoginButton = ({ className = "" }) => {
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center gap-3 w-full py-3 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors duration-200 ${className}`}
    >
      <svg
        className="w-5 h-5"
        viewBox="0 0 24 24"
