...
const ServiceCard = ({ icon: Icon, heading, content, iconColor, url }) => {
  return (
    <Link
      to={url}
      className={
        "group relative flex flex-col justify-center items-center gap-4 transition-transform duration-300 transform hover:-translate-y-1 " +
    ...
    >
      ...
      <div className="text-primaryRgb transition-transform group-hover:scale-110">
