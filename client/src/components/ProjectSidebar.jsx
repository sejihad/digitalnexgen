...
const ProjectSidebar = ({
  ...
  // Initialize openCategory based on selectedCategory
  ...
  const categories = [
    ...
    },
    {
      ...
      subcategories: [
        ...
        { name: "Fashion & Merchandise", value: "fashion-merchandise" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { name: "Social & Marketing Videos", value: "social-marketing-videos" },
      ],
    },
    {
      name: "Business",
      ...
      subcategories: [
        {
          ...
          value: "business-formation-growth",
        },
        { name: "General Administrative", value: "general-administrative" },
  ...
  // Sync openCategory with selectedCategory (for back navigation)
  useEffect(() => {
  ...
  const handleCategoryToggle = (categoryValue) => {
    ...
    setOpenCategory((prev) => (prev === categoryValue ? null : categoryValue));
  };

  const handleSubSelect = (subcategoryValue) => {
    setSelectedSubCategory(subcategoryValue);
    // Do NOT close openCategory
  };
      ...
      <div className="overflow-y-auto max-h-[80vh] pr-2">
        <ul className="space-y-4">
          {categories.map((category) => (
            <li
              key={category.value}
              className="relative dark:text-[#ededed] group"
            >
              <div
